            ...
            <div className="container-fluid">
                ...
                <div className="row">
                    <footer className="col sm-12 text-center">
                        <a href="https://www.kennelliitto.fi/en/dog-ownership/getting-dog/dont-support-puppy-mills">Don't support puppy mills!</a>
                        <br/>
    ...
    render() {
        ...
        return(
            <div className="row" style={rowStyle}>
                ...
                <div className="col-sm-3 col md-3 col-lg-4" style={bgStyle}>
                </div>
            </div>
        );
